<%@ Page Title="Withdrawal Requests" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="withdrawal-requests.aspx.cs" Inherits="admin_withdrawal_requests" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="withdrawal-history.aspx" class="btn btn-outline-warning btn-md"><strong>Withdrawal History</strong></a>
            </div>
        </div>
    </div>
    <div class="card mt-4">
