...
public partial class admin_withdrawal_history : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from withdrawal ORDER BY sr DESC";
    ...
    public void all_transactions_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from withdrawal";
